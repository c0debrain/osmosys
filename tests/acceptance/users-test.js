...
import startApp from 'osmosys/tests/helpers/start-app';
import { PREDEFINED_USER_ROLES } from 'osmosys/mixins/user-roles';
  ...
  runWithPouchDump('default', function() {
    ...
    andThen(() => {
      ...
      andThen(function() {
        ...
        assert.equal(find('td.user-display-name:first').text(), 'OsmoSys Administrator');
