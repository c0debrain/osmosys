...
import AllergyActions from 'osmosys/mixins/allergy-actions';
import BloodTypes from 'osmosys/mixins/blood-types';
import DiagnosisActions from 'osmosys/mixins/diagnosis-actions';
import Ember from 'ember';
import PatientId from 'osmosys/mixins/patient-id';
import PatientNotes from 'osmosys/mixins/patient-notes';
import ReturnTo from 'osmosys/mixins/return-to';
import SelectValues from 'osmosys/utils/select-values';
import UserSession from 'osmosys/mixins/user-session';
import VisitStatus from 'osmosys/utils/visit-statuses';
import PatientVisits from 'osmosys/mixins/patient-visits';
