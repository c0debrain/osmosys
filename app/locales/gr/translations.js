export default {
  ...
  dashboard: {
    ...
    standalone_welcome: '<h4>Ευχαριστούμε για την λήψη του OsmoSys</h4><p>Εκτελείτε το OsmoSys σε κατάσταση stand alone. Αυτή η λειτουργία σας δίνει τη δυνατότητα να υποστηρίξετε πολλούς χρήστες σε μιά μοναδική εγκατάσταση του OsmoSys, τοπικά, σε desktop/laptop. Αυτό είναι ιδανικό για:</p><ul><li>Να αξιολόγησετε το OsmoSys για μια ενδεχόμενη εγκατάσταση σε server</li><li>Να χρησιμοποιήσετε την πλατφόρμα για την υποστήριξη μιας κλινικής/ιατρείου όπου μια εγκατάσταση αρκεί</li></ul><p>Εάν σκέφτεστε το ενδεχόμενο μιας κεντρικής εγκατάστασης του OsmoSys, στην οποία θα έχουν πρόβαση πολλές συσκευές, <a href="https://github.com/osmosys/hospitalrun-frontend/issues/1048" target="_blank">δουλεύουμε σε χαρακτηριστικά</a> τα οποία θα σας επιτρέψουν να μεταφερθείτε από αυτή την τοπική εγκατάσταση σε μια παραδοσιακή cloud/server εγκατάσταση.</p>',
    title: 'Καλώς ήρθατε στο OsmoSys!'
  },
  dates: {
