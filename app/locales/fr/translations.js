export default {
  ...
  dashboard: {
    ...
    standalone_welcome: "<h4>Merci d'avoir téléchargé OsmoSys</h4><p>OsmoSys s'exécute en mode autonome. Ce mode supporte plusieurs utilisateurs sur une seule instance d'OsmoSys sur PC/ordinateur portable. Idéal pour :</p><ul><li>Evaluer OsmoSys pour un potentiel déploiement sur un serveur.</li><li>Utiliser la plateforme pour une clinique / établissement où une seule instance suffit</li></ul><p>Si vous considérez un déploiement sur plusieurs apperails, nous travaillons <a href=\"https://github.com/osmosys/hospitalrun-frontend/issues/1048\" target=\"_blank\">sur des fonctionnalités</a> qui vous permettront de \"migrer\" depuis cette unique instance vers un cloud traditionnel / déploiement basé sur un serveur.</p>",
