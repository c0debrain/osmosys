...
import OsmoSysVersion from 'osmosys/mixins/hospitalrun-version';
import ModalHelper from 'osmosys/mixins/modal-helper';
import ProgressDialog from 'osmosys/mixins/progress-dialog';
import UserSession from 'osmosys/mixins/user-session';
import Navigation from 'osmosys/mixins/navigation';

export default Ember.Controller.extend(OsmoSysVersion, ModalHelper, ProgressDialog, UserSession, Navigation, {
