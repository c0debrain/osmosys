...
testCouchServer(couchurl)
  ...
  .catch((err) => {
    console.error('Oops! Looks like CouchDB isn\'t running. CouchDB must be running before you can start OsmoSys.');
    console.error('For help or more info see https://github.com/osmosys/hospitalrun-frontend#install');
  });
