...
echo "Setting up OsmoSys config DB"
...
echo "Setting up OsmoSys main DB"
...
echo "Add hradmin user for use in OsmoSys"
curl -X PUT $SECUREHOST/_users/org.couchdb.user:osadmin -d '{"name": "osadmin", "password": "test", "roles": ["System Administrator","admin","user"], "type": "user", "userPrefix": "p1"}'
